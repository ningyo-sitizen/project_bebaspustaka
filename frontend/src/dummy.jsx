    ...
    const loginweb = async (e) => {
        ...
        try {
            ...
            if (res.ok) {
                ...
                const user_action = "user melakukan login";
                ...
                const logRes = await fetch("http://localhost:8080/api/logger/logging", {
                    method: "POST",
                    headers: {
                ...
                const logger = await logRes.json();
                console.log(logger);
                ...
                }).catch(err => console.log("SYNC ERROR (diabaikan):", err));
